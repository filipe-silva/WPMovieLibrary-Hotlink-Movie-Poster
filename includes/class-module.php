...
if ( ! class_exists( 'WPMOLY_HT_Module' ) ) {
	...
	abstract class WPMOLY_HT_Module {
		...
		public static function render_template( $default_template_path = false, $variables = array(), $require = 'once' ) {
			...
			do_action( 'wpmoly_ht_render_template_pre', $default_template_path, $variables );
			...
			$template_path = apply_filters( 'wpmoly_ht_template_path', $template_path );
			...
			if ( is_file( $template_path ) ) {
				...
				$template_content = apply_filters( 'wpmoly_ht_template_content', ob_get_clean(), $default_template_path, $template_path, $variables );
			}
			else
				$template_content = '';

			do_action( 'wpmoly_ht_render_template_after', $default_template_path, $variables, $template_path, $template_content );
